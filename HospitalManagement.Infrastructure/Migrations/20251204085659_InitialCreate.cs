        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeAddress = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    LastLoginAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Discriminator = table.Column<string>(type: "TEXT", maxLength: 8, nullable: false),
                    Specialization = table.Column<int>(type: "INTEGER", nullable: true),
                    HealthCard = table.Column<string>(type: "TEXT", maxLength: 12, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecordEntries_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecordEntries_PatientRecords_PatientRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecordEntries_DoctorId",
                table: "RecordEntries",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_RecordEntries_PatientRecordId",
                table: "RecordEntries",
